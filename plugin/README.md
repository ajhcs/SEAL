...
- `docs/` - plugin-facing documentation, including the product contract, plain-language glossary, artifact template, source authority rules, example workflows, release checklist, launch assets, MCP tool contract, App output schemas, adapter security/privacy boundaries, App submission readiness checklist, and the local plugin smoke procedure.
