...
- `docs/` - plugin-facing documentation, including the product contract, plain-language glossary, artifact template, source authority rules, and the local plugin smoke procedure.
